...
function Card({ place }) {
    ...
    return (
        <div
            className="container-fluid accordion-print lead"
            key={Math.random()}
        >
            <div className="row">
                                ...
                                <div className="card-body">
                                    <>
                                        {place.map((singlePlace, index) => {
                                            let transportIncluded =
                                                singlePlace.transports.length >
                                                0;
                                            let accomodationIncluded =
                                                singlePlace.accomodations
                                                    .length > 0;
                                            return (
                                                <div className="d-flex row">
                                                    ...
                                                    <div className="col-11">
                                                        ...
                                                        <CheckUncheck
                                                            included={
                                                                singlePlace.included
                                                            }
                                                            notIncluded={
                                                                singlePlace.notIncluded
                                                            }
                                                        />
                                                    </div>
                                                </div>
