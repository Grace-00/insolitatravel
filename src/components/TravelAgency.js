                            ...
                            <div className="row">
                                <div className="col-12 col-lg-6 separatore">
                                    ...
                                    <div className="container-contact d-flex align-items-center align-items-lg-end pl-sm-3 mt-3 mt-sm-0 h-100">
                                        <div className="h-100">
                                            ...
                                            <p
                                                className="mt-0 normal-text rob mb-3"
                                                style={{
                                                    fontSize: "15",
                                                    lineHeight: "2",
                                                }}
                                ...
                                <div className="col-12 col-lg-6 pl-3 pl-md-4 mb-5 mb-md-0">
                                    ...
                                    <div className="container-contact d-flex align-items-center">
                                        <div>
                                            <p className="rob normal-text m-0">
                                                - Insolita Travels di InSicilia
                                                snc: Tour Operator Sicilia, DMC
                                                e Agenzia di Viaggi;
                                            </p>
                                            <p className="rob normal-text m-0">
                                                - Licenza Agenzia Viaggio nr.
                                                2226/S2-TUR della Regione
                                                Siciliana;
                                            </p>
                                            <p className="rob normal-text m-0">
                                                - Polizza R.C. nr. 45130310-RC14
                                                Europaische Reiserversicherung
                                                AG;
                                            </p>
                                            <p className="rob normal-text m-0">
                                                - InSicilia snc è iscritta
                                                all'Ufficio Registro Imprese di
                                                Catania N. REA 260386;
                                            </p>
                                            <p className="rob normal-text m-0">
                                                - Fondo Garanzia Viaggi:
                                                Certificato n. A/286.1059/1/R;
                                            </p>
                                        </div>
                                    </div>
                                </div>
